...
class SingleSpermBezierIncrementsDataAugSimplified: # # TODO: Remove gym dependencies (gym.Env):
    ...
    def __init__(self,
        ...
        self.timesteps = 0
        # TODO: Remove gym dependencies
        self.action_space = np.array((2,)) #spaces.Box(low=-1, high=1., shape=(2,), dtype=np.float32)
        high = np.array([10. for i in range(14)]).astype(np.float32)
        low = np.array([-10. for i in range(14)]).astype(np.float32)
        # TODO: Remove gym dependencies
        self.observation_space = np.array([high, low]) #spaces.Box(low, high)
...
# class SingleSpermBezierIncrementsDataAugSimplifiedOriginal(SingleSpermBezierIncrements):
#
#     # State: [Spline params, velocity vector, correction angle vector]
#     # Use jointly with the SequenceDatasetSpermNormalized
#     def __init__(self,
